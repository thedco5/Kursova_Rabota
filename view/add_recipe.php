...
<head>
    ...
    <title>Качване на рецепта</title>
</head>
<body>
    <div class="container">
        <div class="form-container mb-5 mt-5">
        <h1 class="pb-5 pt-2 text-center">Качване на рецепта</h1>
        <form action="#" method="post">

            <div class="form-group">
                <label for="recipe_name">Име на рецептата:</label>
            ...
            <div class="form-group">
                <label for="recipe_image">Снимка на рецептата:</label>
                <input type="file" name="recipe_image" id="recipe_image" class="form-control-file" required>
            </div>

            <div class="form-group text-center">
            <button type="submit" class="btn btn-primary">Качи рецептата</button>
            </div>
